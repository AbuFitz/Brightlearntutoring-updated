...
const tiers: { name: Package; price: string; desc: string; features: string[]; featured: boolean }[] = [
  ...
  },
  {
    ...
    features: ["Group of 5 lesson (1 hour)", "4 sessions per month", "Custom learning plan", "Parent report", "End of term assessment", "End of topic assessment"],
    featured: true,
  },
  {
    ...
    features: ["Group of 5 lesson (1 hour)", "4 sessions per month", "Custom learning plan", "Parent report", "Past paper sessions", "Mock exam support"],
    featured: false,
  },
];
