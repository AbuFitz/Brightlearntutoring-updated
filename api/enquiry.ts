...
function buildAdminHtml(d: EnquiryPayload): string {
  ...
  const body = `
    ...
    <p style="margin:0 0 24px;font-size:13px;color:#6b6560;line-height:1.65;">Submitted via the BrightLearn website. Please respond within <strong>24 hours</strong>.</p>
...
function buildConfirmationHtml(d: EnquiryPayload): string {
  ...
  const progAccent =
    programme.includes("KS2") ? { bg: "#dbeafe", text: "#1d4ed8", bar: "#3b82f6" }
    : programme.includes("KS3") ? { bg: "#d1fae5", text: "#065f46", bar: "#10b981" }
...
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;color:#f4f2ee;">Thanks ${firstName} — your BrightLearn enquiry is confirmed. We'll be in touch within 24 hours. &zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;</div>
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;">
  ...
  <tr><td style="background:#111111;border-radius:20px 20px 0 0;padding:22px 32px;">
    <div style="color:#ffffff;font-size:20px;font-weight:700;line-height:1;letter-spacing:-0.01em;">BrightLearn</div>
    <div style="color:rgba(255,255,255,0.45);font-size:11px;margin-top:4px;">Tutoring</div>
  </td></tr>
  ...
  <tr><td style="background:#ffffff;padding:36px 32px 30px;">
    ...
    <p style="margin:0;font-size:14px;color:#6b6560;line-height:1.75;">We'll be in touch within <strong style="color:#111111;">24 hours</strong> — usually much sooner. No commitment needed at this stage.</p>
  </td></tr>
  ...
  <tr><td style="background:#ffffff;padding:28px 32px 32px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:10px;">
      <tr>
        <td style="vertical-align:top;padding-right:16px;width:36px;"><div style="width:36px;height:36px;background:#eff6ff;border-radius:50%;text-align:center;line-height:36px;font-size:13px;font-weight:800;color:#2563eb;">1</div></td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:10px;">
      <tr>
        <td style="vertical-align:top;padding-right:16px;width:36px;"><div style="width:36px;height:36px;background:#ecfdf5;border-radius:50%;text-align:center;line-height:36px;font-size:13px;font-weight:800;color:#059669;">2</div></td>
        <td style="vertical-align:middle;border-bottom:1px solid #f4f1eb;padding:0 0 20px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
      <tr>
        <td style="vertical-align:top;padding-right:16px;width:36px;"><div style="width:36px;height:36px;background:#f5f3ff;border-radius:50%;text-align:center;line-height:36px;font-size:13px;font-weight:800;color:#7c3aed;">3</div></td>
  ...
  ${summaryRows.length ? `<tr><td style="background:#f9f8f5;border-top:1px solid #e9e6de;border-bottom:1px solid #e9e6de;padding:24px 32px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">${summaryRows.join("")}</table>
  </td></tr>` : ""}
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#f9f8f5;border-radius:14px;border:1px solid #e9e6de;">
      <tr><td style="padding:24px 26px;">
        ...
        <table cellpadding="0" cellspacing="0" role="presentation"><tr>
          <td style="padding-right:10px;"><a href="mailto:${ADMIN_EMAIL}" style="display:inline-block;background:#111111;color:#ffffff;font-size:13px;font-weight:700;padding:12px 24px;border-radius:100px;text-decoration:none;">Email us</a></td>
          <td><a href="https://brightlearntutoring.co.uk" style="display:inline-block;background:#ffffff;color:#111111;font-size:13px;font-weight:700;padding:11px 22px;border-radius:100px;text-decoration:none;border:1px solid #ddd6ca;">Visit website</a></td>
        </tr></table>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="padding:28px 8px 0;text-align:center;">
    <table cellpadding="0" cellspacing="0" role="presentation" style="margin:0 auto 16px;"><tr>
      <td style="padding:0 4px;"><a href="https://www.tiktok.com/@brightlearntutoring" style="display:inline-block;background:#1a1a1a;border-radius:8px;padding:7px 13px;text-decoration:none;"><span style="color:#ffffff;font-size:11px;font-weight:600;">TikTok</span></a></td>
      <td style="padding:0 4px;"><a href="https://www.instagram.com/brightlearn_tutoring/" style="display:inline-block;background:#1a1a1a;border-radius:8px;padding:7px 13px;text-decoration:none;"><span style="color:#ffffff;font-size:11px;font-weight:600;">Instagram</span></a></td>
      <td style="padding:0 4px;"><a href="https://www.youtube.com/channel/UCwLfSed7TDecNnVqY5RjuFQ" style="display:inline-block;background:#1a1a1a;border-radius:8px;padding:7px 13px;text-decoration:none;"><span style="color:#ffffff;font-size:11px;font-weight:600;">YouTube</span></a></td>
    </tr></table>
